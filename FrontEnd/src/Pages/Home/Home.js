...
export default function Home() {
    ...
    return (
        <div>
            ...
            <MainContainer>
                <Header gutter={[0,20]}>
                    <ColAni xs={{ span: 20, offset: 0 }} lg={{ span: 13, offset: 0 }} style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                        <div style={{ fontSize: "80px", fontWeight: "200", lineHeight: "80px", color: "#444444" }}>We Deliver</div>
                        <div style={{ fontSize: "80px", fontWeight: "500", lineHeight: "80px", color: "#5BCAD6" }}>Value</div>
                        <div style={{ fontSize: "20px", fontWeight: "300", color: "#6c6c6c", maxWidth: "600px", marginTop: "4vh" }}>
                ...
                <div style={{ background: "#303030"}}>
                    <Segment2>
                        <ColAni xs={{ span: 22, offset: 0 }} sm={{ span: 22, offset: 0 }} lg={{ span: 10, offset: 0 }} style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                            <div style={{ fontSize: "80px", fontWeight: "200", lineHeight: "80px", color: "white" }}>PRACTICE AND</div>
                            <div style={{ fontSize: "80px", fontWeight: "500", lineHeight: "80px", color: "#5BCAD6" }}>LEARN.</div>
                            <div style={{ fontSize: "21px", fontWeight: "400", color: "white", maxWidth: "530px", marginTop: "4vh" }}>
                ...
                <Segment5>
                    ...
                    <div style={{ fontSize: "25px", color: "white", textAlign: "center", width: "70%", fontWeight: "300" }}>Welcome to the National Hookah Community Association "NHCA".
                ...
                <Segment6 ref={containerRef}>
                    ...
                    <Row style={{ marginTop: "4vh", minHeight:"292px" }} >
                        <Slide {...(renderReviews ? { timeout: 2000 } : {})}
                            ...
                            <Comment1 xs={{ span: 24, offset: 0 }} lg={{ span: 14, offset: 10 }}>
                                <MidPic1 style={{ width: "38%", height: "100%", backgroundColor: "white" }}>
                                    <img src={profilePic}></img>
                                </MidPic1>
                                <div style={{
                                    width: "62%", height: "100%", backgroundColor: "#F0F0F0", display: "flex",
                                    flexDirection: "column", gap: "10px", justifyContent: "center", padding: "20px 0px 20px 15px"
                                }}>
                                    <div style={{ color: "#444444", fontSize: "25px", fontWeight: "600" }}>{reviews[count].reviewTitle}</div>
                                    <div style={{ width: "95%", "fontSize": "16px", "fontWeight": "400", "color": "rgba(49, 49, 49, 1)" }}>
                                        {reviews[count].reviewText}
                                    </div>
                                    <Rating precision={0.5} readOnly name="size-small" value={reviews[count].rate} size="small" />
                                    <div style={{ fontSize: "18px", fontWeight: "600", color: "#6c6c6c" }}>{reviews[count].userName}</div>
                                </div>
                            </Comment1>
                        </Slide>
                    </Row>
                    <Row style={{ marginTop: "4vh",minHeight:"292px" }}>
                        <Slide {...(renderReviews ? { timeout: 2000 } : {})}
                            ...
                            <Comment2 xs={{ span: 24, offset: 0 }} lg={{ span: 14, offset: 0 }}>
                                <div style={{
                                    width: "62%", height: "100%", backgroundColor: "#F0F0F0", display: "flex",
                                    flexDirection: "column", gap: "10px", justifyContent: "center", padding: "20px 0px 20px 15px"
                                }}>
                ...
                <Segment7>
                <div style={{ display: "flex", gap: "10px", fontSize: "50px", lineHeight: "60px", fontWeight: "100",marginBottom:"20px", color:"#444444", width:"100%", alignItems:"baseline",justifyContent:"center" }}>Our<div style={{ fontWeight: "500", color: "#5BCAD6" }}>Happy</div>Customers</div>
                    <Splide
                        options={{
                            type: 'loop',
                            perPage: 5,
                ...
                <Segment8 id='contactus'>
                    ...
                    <Col xs={{ span: 24, offset: 0 }} lg={{ span: 11, offset: 0 }} style={{display:"flex", flexDirection:"column", gap:"40px"}}>
                                <div style={{color:"white", fontWeight:"600", fontSize:"95px", lineHeight:"120px"}}>ENGAGE & <br/> EXPERINCE</div>
