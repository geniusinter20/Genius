    ...
    return (
      ...
      !this.state.dataLoaded ? <div style={{ width: "100%", height: "100%", marginTop:"15vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
        ...
        <MainContainer>
            ...
            currentProducts.map((product) => {
              return (
                <Card
                  ...
                  cover={<Image><img alt="example" src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" /></Image>}
                >
                  <ProductDtails>
          ...
          <Pagination defaultPageSize={this.state.productsPerPage} size="small" total={numberOfProducts} onChange={(current, numberOfProducts) => { this.changeCurrentPage(current) }} />
        </MainContainer>
