    ...
    //console.log(state)
         ...
         <MainContainer>
              <div className='pageBackground'>
                ...
                {started && !finished ? 
                <QuestionsForm examID={examInfo.key} navigate={navigate} setFinished={setFinished} examSession={examSession} questions={questions !== undefined? questions: []} examInfo={examInfo} /> : !finished? <StartScreen setStarted={setExamStarted} examInfo={examInfo}/>
                :<FinishScreen examID={examInfo.key} navigate={navigate} examInfo={examInfo} examSession={examSession}></FinishScreen>}
         </MainContainer>
    );
}
